...
class CategoriesController extends Component
{
    ...
    public function Store()
    {
        ...
        $messages = [
            'name.required' => 'Nombre de la catergoría es requerido',
            'name.unique' => 'Ya existe el nombre de la categoría',
            'name.min' => 'El nombre de la categoría dene tener al menos 3 caracteres'
        ];
    ...
    public function Update()
    {
        ...
        if($this->image)
        {
            ...
            if($imageName != null)
            {
                if(file_exists('storage/cate' . $imageName))
                {
                    inlink('storage/categories' . $imageName);
                }
            }
        }
    ...
    public function Destroy(Category $category)
    {
        ...
        //dd($category);
        $imageName = $category->image; //imagen tempnam
        $category->delete();
