						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<span>
										<img src="{{ asset('storage/products/' . $product->imagen ) }}" alt="imagen ejemplo" height="70" width="80" class="rounded">
									</span>
								</td>
{{-- 								<td><h6 class="text-center">{{ $product->size_id }}</h6></td> --}}
...
<script>
	document.addEventListener('DOMContentLoaded', function(){
		...
		window.livewire.on('hidden.bs.updated', msg =>{
			$('.er').css('display','none')
		});
	});
